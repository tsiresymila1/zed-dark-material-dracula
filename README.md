...
A dark theme for the [Zed editor](https://zed.dev/), based on the popular [Dark Material Dracula theme for VS Code](https://github.com/tsiresymila1/dark-material-dracula).
...
This theme is a port of the [Dark Material Dracula](https://github.com/tsiresymila1/dark-material-dracula) theme by [caumeira](https://github.com/tsiresymila1).
